...
namespace SimpleLicense.LicenseValidation
{
    ...
    public static class FieldValidators
    {
        ...
        /// <summary>
        /// Registers all default validators for standard license fields.
        /// </summary>
        private static void RegisterDefaultValidators()
        {
            _validators["LicenseId"] = ValidateLicenseId;
            _validators["ExpiryUtc"] = ValidateExpiryUtc;
            _validators["Signature"] = ValidateSignature;
        }
